...
class Ui_MainWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.removeAll = QtWidgets.QPushButton("Remove All", self.centralwidget)
        self.removeAll.setGeometry(QtCore.QRect(220, 510, 181, 71))
        font = QtGui.QFont()
        font.setFamily("OCR A Extended")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.removeAll.setFont(font)
        self.removeAll.setObjectName("addChorus")
        self.removeAll.clicked.connect(self.add_chorus)

        self.removeLast = QtWidgets.QPushButton("Remove Last", self.centralwidget)
        self.removeLast.setGeometry(QtCore.QRect(410, 510, 181, 71))
        font = QtGui.QFont()
        font.setFamily("OCR A Extended")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.removeLast.setFont(font)
        self.removeLast.setObjectName("addChorus")
        self.removeLast.clicked.connect(self.add_chorus)
